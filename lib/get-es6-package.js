...
var pickFiles  = require('broccolo-static-compiler');
...
var inlineTemplatePrecompiler = require('./inline-template-precompiler');

var disableJSHint = config.disableJSHint;

module.exports = function getES6Package(packageName) {
