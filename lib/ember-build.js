...
var EmberBuild = CoreObject.extend({
  ...
  _enumeratePackages: function enumeratePackages() {
    ...
    var emberVersionTree     = transpileES6(createEmberVersion());
    var emberDevFeatures     = transpileES6(compileEmberFeatures());
    var emberProdFeatures    = transpileES6(compileEmberFeatures('production'));
