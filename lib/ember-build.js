...
var emberDevTestHelpers = require('./ember-dev-test-helpers');
...
function EmberBuild(options) {
  ...
  this._generateCompiledTestsTree(buildTree.testTrees);
...
EmberBuild.prototype._generateCompiledTestsTree = function generateCompiledTestsTree(testTrees) {
  this._compiledTests = concatES6(testTrees, {
    es3Safe:       !buildConfig.isDevelopment,
...
EmberBuild.prototype._generateProdCompiledTestsTree = function generateProdCompiledTestsTree(testTrees) {
  this._prodCompiledTests = concatES6(testTrees, {
    es3Safe:       !buildConfig.isDevelopment,
