...
var EmberBuild = CoreObject.extend({
  ...
  _enumeratePackages: function enumeratePackages() {
    ...
    var emberVersionTree     = transpileES6(createEmberVersion(this._version));
    var emberDevFeatures     = transpileES6(compileEmberFeatures(this._features.development));
    var emberProdFeatures    = transpileES6(compileEmberFeatures(this._features.production));
